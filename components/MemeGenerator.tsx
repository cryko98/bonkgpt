...
export const MemeGenerator: React.FC = () => {
  ...
  const handleDownload = () => {
    if (canvasRef.current) {
      ...
      link.download = `bonk-image-${Date.now()}.png`;
      ...
      <div className="w-full md:w-1/3 p-6 bg-gray-50 border-r border-gray-200 overflow-y-auto">
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {!referenceImage ? (
                <div 
                    ...
                    className="w-full h-20 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center text-gray-400 hover:border-bonk-orange hover:text-bonk-orange transition-colors cursor-pointer"
                >
                    <Upload size={20} />
                ...
                {STYLES.map(style => (
                    <button
                        ...
                        className={`py-2 px-3 text-xs font-bold rounded-lg border transition-all ${
                            ...
                            ? 'bg-bonk-orange text-white border-bonk-orange' 
          ...
          <div className="space-y-4 pt-4 border-t border-gray-200">
             ...
             <div className="space-y-2">
                <input 
                    ...
                    className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-bonk-orange"
          ...
          <button 
            ...
            className="w-full bg-bonk-black text-white font-bold py-3 rounded-xl hover:bg-gray-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-4"
          >
            {isGenerating ? (
                <>
      ...
      <div className="w-full md:w-2/3 bg-gray-200 flex items-center justify-center p-6 relative overflow-hidden bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]">
            ...
            {isGenerating && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/50 backdrop-blur-sm z-10">
                    <div className="w-16 h-16 border-4 border-bonk-orange/30 border-t-bonk-orange rounded-full animate-spin mb-4"></div>
                    <p className="font-bold text-bonk-orange animate-pulse">Computing Vibes...</p>
                </div>
            )}
            ...
            {generatedImage && (
                <div className="absolute bottom-6 right-6">
                    <button 
                        ...
                        className="bg-bonk-orange text-white px-6 py-3 rounded-full font-bold shadow-xl hover:bg-bonk-dark hover:scale-105 transition-all flex items-center gap-2"
                    >
